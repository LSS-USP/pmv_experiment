...
if (experiment_to_run == "VALIDATION"):
    ...
    model_path = "hdfs://hadoop:9000/paulista.csv"
else:
    raise Exception("""
...
def mountValue(edgeId, timestamp, measure_id):
    return json.dumps({"edgeId": edgeId, "timestamp": timestamp, "measure_id": measure_id})
...
if __name__ == '__main__':
    ...
    json_objects = mount_json_extraction(["edge_id", "avg_speed", "timestamp", "measure_id"])
    ...
    (anomaly_detection
            ...
            .select(udfMountValue(col("edge_id"), col("timestamp"), col("measure_id")).alias("value"))
